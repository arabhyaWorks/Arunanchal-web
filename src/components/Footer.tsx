                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-16 border-b border-white/10">
                    ...
                    <div>
                        ...
                        <p className="text-gray-300 text-sm mb-6">
                            Get the DIA mobile app to explore Arunachal's cultural heritage
                            on the go.
                        </p>
                        <div className="space-y-4">
                            <a href="https://apps.apple.com/in/app/indigenous-folklore-and-music/id6736680850" target="_blank" rel="noopener noreferrer" className="block">
                                <img
                            ...
                            <a href="https://play.google.com/store/apps/details?id=com.arunanchal" target="_blank" rel="noopener noreferrer" className="block">
                                <img
                ...
                <div className="pt-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        <p className="text-gray-400 text-sm text-center md:text-left">
                            © 2024 Department of Indigenous Affairs, Arunachal Pradesh. All
                            Rights Reserved.
                        </p>
